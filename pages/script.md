...
vowel parts.  One big difference is that Hangul characters are CVC, while Zoitei
...
are read from right to left, and diphthongs are read from top to bottom.

Similar sounding vowels in the Zoitei script are written similarly.  Front
vowels are written with straight lines (like the unvoiced consonants), while
back vowels are written with curved lines (like the voiced consonants).
